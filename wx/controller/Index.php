...
class Index
{
    ...
    function getToken(){
        return $this->checkAccessToken("wxfb9b14f37bfb6e2b","4fa52811dc1ac27288928a5c21f5120d");//公众帐号的id和tocken
    }
   ...
   public function createmenu(){
    ...
    function postcurl($url,$data = null){
      ...
      public function getuser(){
       ...
       // var_dump($user_info['headimgurl']);
         echo '<img src="'.$user_info['headimgurl'].'"  alt="上海鲜花港 - 郁金香" />';
